...
upimapi --blast -i "${blastout}/${assembly}_\${i}_blp.tsv" -t ${SLURM_CPUS_PER_TASK} -o ${upimapi}/\${i}/ -ot "${upimapi}/\${i}/${assembly}_\${i}_upimapi.tsv" --columns "Organism&Gene Names&Gene Ontology (GO)&InterPro&PANTHER"
